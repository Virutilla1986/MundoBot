	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '1938387173626728827367@newsletter',
...
let canalId = ["19383871736267288273672@newsletter", "https://whatsapp.com/channel/0029VaSZsS14Y9lhQYCFvO0w", "1927371891736761868637@newsletter", "120363231200139983@newsletter"]
let canalNombre = ["MundoBot Novedades1", "Sorteo de bots 2", "🌎 MundoBot novedades 🌎3.", "MundoBot - Novedades"]
